...
public final class Constants
{
  ...
  // 2007/09/17 ‡_ìc ç_ïΩ éÛêMâ¬î\îÕàÕ
  //public static final double SENSITIVITY_DEFAULT = -91.0;
  public static final double SENSITIVITY_DEFAULT = -67.0;
  /** Default radio reception threshold (units: dBm). */
  // 2007/09/17 ‡_ìc ç_ïΩ éÛêMâ¬î\îÕàÕópËáíl
  //public static final double THRESHOLD_DEFAULT = -81.0;
  public static final double THRESHOLD_DEFAULT = -65.0;
