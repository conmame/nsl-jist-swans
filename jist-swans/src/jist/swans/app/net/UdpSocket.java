...
public class UdpSocket
{
  ...
  // 2007/09/17 濱田 浩平 トランスポート層のインターフェース変更
  ...
  // 2007/09/17 濱田 浩平 TTL設定処理 START
  
  private byte ttl = Constants.TTL_DEFAULT;

  public void setTimeToLive(byte ttl){
	  this.ttl = ttl;
  }
  
  // 2007/09/17 濱田 浩平 TTL設定処理 END
