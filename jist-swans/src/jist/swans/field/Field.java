...
//    else{
//    	System.out.println("id = "+id+" is static");
//    }
  }
  ...
  // 2007/09/17 à_“c _•½ ˆÚ“®ƒ‚ƒfƒ‹‚ðmove‚Ì’l‚Å•ÏX START
  public void startMobility(Integer id, boolean move){
	    RadioData rd = getRadioData(id);
	    if(move){
	    	rd.mobilityInfo = mobility.init(self, id, rd.loc);
	    }else{
	    	// static model
	    	rd.mobilityInfo = null;
	    }
	    self.moveRadio(id, rd.loc);
  }
  // 2007/09/17 à_“c _•½ ˆÚ“®ƒ‚ƒfƒ‹‚ðmove‚Ì’l‚Å•ÏX END
